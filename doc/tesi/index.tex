...
\begin{document}
	...
	% Introduzione
	\input{chapters/cap_1.tex}

	% Feature di Haar
	\input{chapters/cap_2.tex}

	% Adaboost
	\input{chapters/cap_3.tex}

	% Validazione
	\input{chapters/cap_4.tex}

	% Rilevamento
	\input{chapters/cap_5.tex}

	% Conclusioni
	\input{chapters/cap_6.tex}

	\begin{appendices}
		\input{appendices/software}
		\input{appendices/kinect}
	\end{appendices}
