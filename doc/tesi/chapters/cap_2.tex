...
\label{chap:features}
    ...
    \label{sec:decision_stump}
        ...
        \subsection{Definizione di Decision Stump}
            ...
            Volendo trovare una descrizione formale unica, si introduce un ulteriore parametro $p \in \{0,1\}$, detto \emph{polarità}, il cui unico compito è quello di invertire il segno della disequazione, permettendo di fondere le formule \ref{subeq:decision_test_pos} e \ref{subeq:decision_test_neg} in \ref{eq:decision_stump_test}.
